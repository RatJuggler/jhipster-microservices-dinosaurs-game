...
import com.rj.dinosaurs.game.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.rj.dinosaurs.game.domain.HighScore}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class HighScoreResource {
    ...
    private static final String ENTITY_NAME = "gameHighScore";
    ...
    public HighScoreResource(HighScoreRepository highScoreRepository) {
    ...
    public ResponseEntity<HighScore> updateHighScore(@Valid @RequestBody HighScore highScore) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, highScore.getId().toString()))
            .body(result);
    }
